...
{
  public class GoogleTranslatorLite: ITranslator
  {
    private readonly GoogleKeyTokenGenerator _generator;
		...
		public GoogleTranslatorLite(string domain = "translate.google.com")
		{
		...
		public async Task<TranslationResult> TranslateAsync(string originalText, Language fromLanguage, Language toLanguage)
		{
			...
			return ResponseToTranslateResultParse(result, originalText, fromLanguage, toLanguage);
		}
